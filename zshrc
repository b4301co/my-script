...
alias casa='xfreerdp /v:192.168.1.5 /u:alkiopprroo@hotmail.com /cert-ignore /dynamic-resolution +auto-reconnect +clipboard +home-drive'
alias casardp='xfreerdp /v:klaio.duckdns.org:435 /u:alkiopprroo@hotmail.com /cert-ignore /dynamic-resolution +auto-reconnect +clipboard +home-drive'
alias casaovpn='xfreerdp /v:10.248.0.2 /u:alkiopprroo@hotmail.com /cert-ignore /dynamic-resolution +auto-reconnect +clipboard +home-drive'
alias rem='xfreerdp /v:192.168.122.130 /u:alkio /cert-ignore /dynamic-resolution +auto-reconnect +clipboard +home-drive'
alias kali='ssh kali@192.168.122.157 -X '
alias s='sudo'
alias app='sudo winapps'
alias drive='rclone mount alkio: ~/alkioDrive &'
...
export PATH="$PATH:/home/alkio/.local/bin"
